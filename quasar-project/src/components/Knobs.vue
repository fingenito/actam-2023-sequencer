<template>
  <fieldset class="knob-container">
    <input type="number" id="r" value="50" min="0" max="100" step="1" placeholder="-"/>
    <label for="r" accesskey="r" data-unit="db">Volume</label>
  </fieldset>
  <fieldset class="knob-container">
    <input type="number" id="t" value="0" min="-10" max="10" step="0.2" placeholder="-"/>
    <label for="t" accesskey="t">Knobtype2</label>
